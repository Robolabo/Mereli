...
from spike_swarm_sim.algorithms.evolutionary import CPPN_NEAT
...
populations = {
    "p1" : {    
        "objects" : ["synapses:weights:all", "neurons:bias:all", "neurons:activation:all"],
        "max_vals" : [5,  3, 0],
        "min_vals" : [-5, -3, 5],
        "params" : {
            "encoding" : "real",
...
cppn_neat = CPPN_NEAT(populations, world,
