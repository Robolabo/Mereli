...
def get_formation(formation_name):
    return { 
        ...
        1.5*np.array([[1.0, 0.0], [0.92, 0.38], [0.71, 0.71], [0.38, 0.92], [-0.0, 1.0], [-0.38, 0.92], [-0.71, 0.71], [-0.92, 0.38], [-1.0, -0.0], [-0.92, -0.38], [-0.71, -0.71], [-0.38, -0.92], [0.0, -1.0], [0.38, -0.92], [0.71, -0.71], [0.92, -0.38]])},
