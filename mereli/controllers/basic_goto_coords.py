...
def get_formation(formation_name):
    return { 
        ...
        'formation_circle_8' : {'nodes' : 
        0.5*np.array([[1.0, 0.0], [0.71, 0.71], [0.0, 1.0], [-0.71, 0.71], [-1.0, 0.0], [-0.71, -0.71], [-0.0, -1.0], [0.71, -0.71]])},
        'formation_circle_16' : {'nodes' : 
        np.array([
            [1.0, 0.0], [0.71, 0.71], [0.0, 1.0], [-0.71, 0.71], [-1.0, 0.0], [-0.71, -0.71], [-0.0, -1.0], [0.71, -0.71], [2.0, 0.0], [1.41, 1.41], [0.0, 2.0], [-1.41, 1.41], [-2.0, 0.0], [-1.41, -1.41], [-0.0, -2.0], [1.41, -1.41]
            ])},
        'formation_circle_24' : {'nodes' : 
        np.array([[1.0, 0.0], [0.71, 0.71], [0.0, 1.0], [-0.71, 0.71], [-1.0, 0.0], [-0.71, -0.71], [-0.0, -1.0], [0.71, -0.71], [2.0, 0.0], [1.85, 0.77], [1.41, 1.41], [0.77, 1.85], [-0.0, 2.0], [-0.77, 1.85], [-1.41, 1.41], [-1.85, 0.77], [-2.0, -0.0], [-1.85, -0.77], [-1.41, -1.41], [-0.77, -1.85], [0.0, -2.0], [0.77, -1.85], [1.41, -1.41], [1.85, -0.77]])},
        'formation_circle_40' : {'nodes' : 
        np.array([[1.0, 0.0], [0.71, 0.71], [0.0, 1.0], [-0.71, 0.71], [-1.0, 0.0], [-0.71, -0.71], [-0.0, -1.0], [0.71, -0.71], [2.0, 0.0], [1.85, 0.77], [1.41, 1.41], [0.77, 1.85], [-0.0, 2.0], [-0.77, 1.85], [-1.41, 1.41], [-1.85, 0.77], [-2.0, -0.0], [-1.85, -0.77], [-1.41, -1.41], [-0.77, -1.85], [0.0, -2.0], [0.77, -1.85], [1.41, -1.41], [1.85, -0.77], [3.0, 0.0], [2.77, 1.15], [2.12, 2.12], [1.15, 2.77], [-0.0, 3.0], [-1.15, 2.77], [-2.12, 2.12], [-2.77, 1.15], [-3.0, -0.0], [-2.77, -1.15], [-2.12, -2.12], [-1.15, -2.77], [0.0, -3.0], [1.15, -2.77], [2.12, -2.12], [2.77, -1.15]])},
        'formation_circle_56' : {'nodes' : 
        np.array([
            [1.0, 0.0], [0.71, 0.71], [0.0, 1.0], [-0.71, 0.71], [-1.0, 0.0], [-0.71, -0.71], [-0.0, -1.0], [0.71, -0.71], [2.0, 0.0], [1.85, 0.77], [1.41, 1.41], [0.77, 1.85], [-0.0, 2.0], [-0.77, 1.85], [-1.41, 1.41], [-1.85, 0.77], [-2.0, -0.0], [-1.85, -0.77], [-1.41, -1.41], [-0.77, -1.85], [0.0, -2.0], [0.77, -1.85], [1.41, -1.41], [1.85, -0.77], [3.0, 0.0], [2.77, 1.15], [2.12, 2.12], [1.15, 2.77], [-0.0, 3.0], [-1.15, 2.77], [-2.12, 2.12], [-2.77, 1.15], [-3.0, -0.0], [-2.77, -1.15], [-2.12, -2.12], [-1.15, -2.77], [0.0, -3.0], [1.15, -2.77], [2.12, -2.12], [2.77, -1.15], [4.0, 0.0], [3.7, 1.53], [2.83, 2.83], [1.53, 3.7], [-0.0, 4.0], [-1.53, 3.7], [-2.83, 2.83], [-3.7, 1.53], [-4.0, -0.0], [-3.7, -1.53], [-2.83, -2.83], [-1.53, -3.7], [0.0, -4.0], [1.53, -3.7], [2.83, -2.83], [3.7, -1.53]])}
}.get(formation_name)
...
class BasicGOTOCoords(RobotController):
    ...
    def select_coords_lmark_formation(self):
        ...
        neighbors = self.controller_owner.neighbors 
        if len(neighbors) > 0: 
            neigh_positions = np.vstack([epk.position[:2] for epk in neighbors])
        else:
            neigh_positions = self.controller_owner.position
